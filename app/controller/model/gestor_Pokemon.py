...
class gestorPokemon:
    ...
    def mostrarPokemon(self, nombrePokemon):
        sql = "SELECT * FROM PokemonPokedex WHERE nombrePokemon = ?"
        return self.db.select(sql, (nombrePokemon,))
    ...
    def buscar_nombre_real_inteligente(self, nombre_input):
        if not nombre_input: return None
        ...
        if res: return res[0]['nombrePokemon']
    ...
    # --- FUNCIONALIDAD 4: COMPATIBILIDAD (FINAL) ---
    ...
    def _logica_amor(self, nombre1, nombre2):
        ...
        # 3. Generar HTML (Con círculo blanco en el corazón y sin texto extra)
        respuesta_html = (
            ...
            # Corazón con círculo blanco detrás
            ...
            # Texto del porcentaje (Limpio, sin resplandor)
